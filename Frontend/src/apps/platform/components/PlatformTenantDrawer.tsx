      ...
      {open ? (
        <>
          ...
          <motion.aside
            ...
            className={cn(
              'fixed right-0 top-0 z-50 h-screen w-full max-w-[520px] overflow-y-auto border-l border-slate-200/80 bg-white/97 px-5 py-5 shadow-[0_40px_120px_rgba(15,23,42,0.24)] backdrop-blur dark:border-slate-800 dark:bg-slate-950/95'
            )}
          >
            <div className="flex items-start justify-between gap-4">
              <div className="min-w-0">
                ...
                <p className="mt-2 text-sm leading-6 text-slate-500 dark:text-slate-400">
                  Owner visibility into plan, readiness, usage footprint, and next actions.
                </p>
              </div>
              <button
                type="button"
            ...
            {loading ? (
              ...
              <div className="mt-8">
                <EmptyResultsState
                  ...
                  description="Choose a tenant from the table to inspect plan, usage, setup readiness, and owner actions."
                />
              </div>
            )}
          </motion.aside>
