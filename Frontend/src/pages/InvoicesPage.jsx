        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">
              Manage student payments and academic fees
            </p>
          </div>
        </div>
        <button
        ...
        <div className="p-4 border-b border-gray-50 flex items-center justify-between">
          <div className="flex gap-4 items-center">
            ...
            <div className="flex gap-1">
              <button className="px-2 py-1 bg-blue-50 text-blue-600 rounded text-[10px] font-bold">
                All
              </button>
              <button className="px-2 py-1 hover:bg-gray-50 rounded text-[10px] font-bold text-gray-500">
                Unpaid
              </button>
              <button className="px-2 py-1 hover:bg-gray-50 rounded text-[10px] font-bold text-gray-500">
                Paid
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <div className="text-sm font-medium">
                        {inv.studentId?.fullName || 'N/A'}
                      </div>
                      <div className="text-[10px] text-gray-400 tracking-wider">
                        REF: {inv.studentId?._id.substring(18, 24)}
                      </div>
                    </td>
                    <td className="px-6 py-4">
