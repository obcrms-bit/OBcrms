...
const SettingsPage = () => {
    ...
    const handleLogoUpload = (e) => {
        ...
        if (file) {
            if (file.size > 1024 * 1024) {
                setStatus({ type: 'error', message: 'Logo size should be less than 1MB' });
                return;
            }
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setStatus({ type: 'success', message: 'Corporate branding updated successfully!' });
        } catch (error) {
    ...
    return (
        <div className="p-6 max-w-4xl mx-auto">
            <div className="mb-8">
                ...
                <p className="text-gray-500">Customize your portal identity and colors</p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <form onSubmit={handleSubmit} className="p-8 space-y-8">
                    ...
                    <div className="grid md:grid-rows-2 gap-8">
                        {/* Company Name */}
                        <div>
                            <label className="block text-sm font-bold text-gray-700 mb-2">Company Legal Name</label>
                            <input
                                type="text"
                                value={formData.name}
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            ...
                            <div>
                                ...
                                <p className="mt-2 text-xs text-gray-400 font-medium">This color will be used for buttons, sidebar highlights, and topbars.</p>
                            </div>

                            {/* Logo Upload */}
                            <div>
                                <label className="block text-sm font-bold text-gray-700 mb-2">Corporate Logo</label>
                                <div className="flex items-center gap-6">
                                    ...
                                    <div className="flex-1">
                                        <p className="text-xs text-gray-500 font-medium mb-1">Upload a PNG or SVG logo.</p>
                                        <p className="text-[10px] text-gray-400">Max size: 1MB. Recommended size: 200x200px.</p>
                                        <button
                                            type="button"
            ...
            <div className="mt-12">
                ...
                <div className="grid md:grid-cols-2 gap-8">
                    <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
                        <p className="text-xs font-bold text-gray-400 uppercase mb-4">Button Preview</p>
                        <div className="flex gap-4">
                            <button className="px-6 py-2 rounded-lg text-white font-bold text-sm shadow-md" style={{ backgroundColor: formData.primaryColor }}>Primary Action</button>
                            <button className="px-6 py-2 rounded-lg font-bold text-sm border-2" style={{ borderColor: formData.primaryColor, color: formData.primaryColor }}>Secondary</button>
                        </div>
                    </div>
                    <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm overflow-hidden">
                        <p className="text-xs font-bold text-gray-400 uppercase mb-4">Sidebar Item Preview</p>
                        <div className="flex items-center gap-3 px-4 py-2 rounded-lg font-bold text-sm" style={{ backgroundColor: `${formData.primaryColor}15`, color: formData.primaryColor }}>
                            <Palette size={18} />
