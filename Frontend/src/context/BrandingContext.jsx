    ...
    const fetchBranding = async () => {
        try {
            ...
            if (response.data.success) {
                ...
                document.documentElement.style.setProperty('--primary-color', data.primaryColor || '#1890ff');
                ...
                document.documentElement.style.setProperty('--primary-light', lightenColor(data.primaryColor || '#1890ff', 40));
            }
        } catch (error) {
